 ...
 * @since 1.0
 */
class SPDownloadViewMediaList extends JView
{
	function display($tpl = null)
	{
		...
		$document->addStyleSheet('../media/com_spdownload/css/medialist-'.$style.'.css');
		if ($lang->isRTL()) :
			$document->addStyleSheet('../media/com_spdownload/css/medialist-'.$style.'_rtl.css');
		endif;
