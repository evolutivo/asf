...
/**
 * JMediaManager behavior for spdownload component
 *
...
var MediaManager = this.MediaManager = {
	...
	initialize: function()
	{
		...
		this.tree = new MooTreeControl({ div: 'spdownload-tree_tree', mode: 'folders', grid: true, theme: '../media/system/images/mootree.gif', onClick:
				function(node){
			...
			},{ text: 'Media', open: true, data: { url: 'index.php?option=com_spdownload&view=mediaList&tmpl=component', target: 'folderframe'}});
		this.tree.adopt('spdownload-tree');
	},

	submit: function(task)
	{
		form = window.frames['folderframe'].document.id('spdownloadmanager-form');
	...
	setViewType: function(type)
	{
		...
		viewstyle = type;
		var folder = this.getFolder();
		this._setFrameUrl('index.php?option=com_spdownload&view=mediaList&tmpl=component&folder='+folder+'&layout='+type);
	},
