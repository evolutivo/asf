...
$n_single = $nusantara_options['nusantara_single']['enabled'];
if ($n_single): foreach ($n_single as $a_single=>$x_single) {
switch($a_single) {
case 
'nusantara_content_post': ?>
