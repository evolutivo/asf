...
/*-----------------------------------------------------------------------------------*/
	...
	window.send_to_editor = function(html) {
		...
		if (formfield) {
          ...
          if (itemurl.match(image)) {
            btnContent = '<a class="nusantara-uploaded-image" href="'+itemurl+'"><img id="image_'+imgID+'" class="nusantara-option-image" src="'+itemurl+'" alt="" /></a>';
          } else {
  ...
  }; // End nusantaraMLU Object // Don't remove this, or the sky will fall on your head.

/*-----------------------------------------------------------------------------------*/
/* Execute the above methods in the nusantaraMLU object.
/*-----------------------------------------------------------------------------------*/
  
	$(document).ready(function () {

		nusantaraMLU.removeFile();
		nusantaraMLU.recreateFileField();
		nusantaraMLU.mediaUpload();
