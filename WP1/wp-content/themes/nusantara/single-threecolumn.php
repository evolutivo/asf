...
$nusa = $nusantara_options['single_nusa']['enabled'];
if ($nusa): foreach ($nusa as $uj=>$timur) {
switch($uj) {
case 
'nusantara_ntt_left': ?>
<section class="two">
...
<?php
         break;
         case 'nusantara_ntt_right':?>
<section class="two">
<?php get_sidebar('ntt'); ?>
</section >
<?php
         break;
         case 'nusantara_footer_nusa':?>
