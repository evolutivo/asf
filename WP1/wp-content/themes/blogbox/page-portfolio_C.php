...
<div id="fullwidth">
	...
	<?php // additional loop via get_posts
		$category_ID = get_cat_ID(sanitize_text_field($blogBox_option['bB_portfolioC_category']));
		...
		if ($category_ID !== 0 && $custom_posts){
			...
			foreach($custom_posts as $post) : setup_postdata($post);
					if ($blogBox_option['bB_portfolioC_cols'] == "1") {
		 				if (has_post_thumbnail()) {
							...
							echo '<div class="left_col">';
        						echo '<a href="';the_permalink();echo '" title="';the_title_attribute(); echo '" >';
      							...
      							echo '</a>';
      							if($blogBox_option['bB_portfolioC_feature_caption'] == 1) {
      								echo '<div class="display_caption">';
      									echo '<h4>';echo get_post(get_post_thumbnail_id())->post_excerpt;echo '</h4>';
									echo '</div>';
								}
      							if($blogBox_option['bB_portfolioC_feature_description'] == 1) {
					...
					} elseif ($blogBox_option['bB_portfolioC_cols'] == "2") {
			 			...
			 			if (has_post_thumbnail()) {
							...
							$feature_pic_count ++;
								...
								echo '</div>';
	      						...
	      						if($blogBox_option['bB_portfolioC_content'] == 1) {
					...
					} elseif ($blogBox_option['bB_portfolioC_cols'] == "3") {
