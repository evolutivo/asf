...
<?php get_header(); ?>
<div id="widecolumn">
	<h1 class="listhead"><?php _e('Post by Category : ','blogBox'); ?><?php single_cat_title(); ?></h1>
	...
	<?php else : ?>
		...
		<div class="nosearch">
			<h2><?php _e('Sorry about that but we didn\'t find anything posted by that category!','blogBox'); ?></h2>
